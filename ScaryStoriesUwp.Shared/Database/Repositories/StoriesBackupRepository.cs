...
{
    public class StoriesBackupRepository : IStoriesBackupRepository
    {
        private SQLiteAsyncConnection _connection;

        public StoriesBackupRepository(IDbConnection connection)
        {
            _connection = connection.GetAsyncConnection(DatabaseType.Backup);
        }
